...
def create_reservation(student_id, book_id):
    ...
    try:
        ...
        return True, (
            f"Book '{book['title']}' reserved successfully."
        )
...
def update_reservations_for_book(book_id):
    ...
    try:
        ...
        # --------------------------------
        # Number of reservations to process
        # --------------------------------
...
def get_all_reservations():
    ...
    try:
        ...
        cursor.execute("""
            ...
            ORDER BY
                CASE
                    WHEN reservations.status = 'Waiting'
                    THEN 0

                    WHEN reservations.status = 'Ready'
                    THEN 1
...
def expire_old_reservations():
    ...
    try:
        ...
        expiry_cutoff = (
            date.today()
            - timedelta(days=RESERVATION_HOLD_DAYS)
        ).isoformat()
